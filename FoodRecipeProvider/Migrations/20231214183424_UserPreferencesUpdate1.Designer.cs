...
namespace FoodRecipeProvider.Migrations
{
    ...
    [Migration("20231214183424_UserPreferencesUpdate1")]
    partial class UserPreferencesUpdate1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodRecipeProvider.Models.UserPreferences", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodRecipeProvider.Models.UserPreferences", b =>
                {
                    b.HasOne("FoodRecipeProvider.Models.CuisineType", null)
                        .WithMany("UserPreferences")
                        .HasForeignKey("CuisineTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodRecipeProvider.Models.DietLabel", null)
                        .WithMany("UserPreferences")
                        .HasForeignKey("DietLabelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodRecipeProvider.Models.DishType", null)
                        .WithMany("UserPreferences")
                        .HasForeignKey("DishTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodRecipeProvider.Models.HealthLabel", null)
                        .WithMany("UserPreferences")
                        .HasForeignKey("HealthLabelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodRecipeProvider.Models.MealType", null)
                        .WithMany("UserPreferences")
                        .HasForeignKey("MealTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodRecipeProvider.Models.AppUser", "User")
                        .WithMany("UserPreferences")
